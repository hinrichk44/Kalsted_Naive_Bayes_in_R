#For this project we will be working with the Naive Bayes algorithm
...
#Here we are fitting Naive Bayes to the Training set
#First we import the e1071 library
library(e1071)

#Now we set up our Naive Bayes classifier
#Notice how we don't need "formula = y~x"
